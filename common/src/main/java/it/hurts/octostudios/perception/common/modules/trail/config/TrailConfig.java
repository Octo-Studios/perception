...
public class TrailConfig implements OctoConfig {
    ...
    private Map<String, TrailConfigData> entityTrails = new HashMap<>() {{
        ...
        put("minecraft:fireball", new TrailConfigData(0.35F, 5, 0.001F, 1, "#FFEBAA18", "#80800000", new Vector3f(0F, 0.35F, 0F), 0F, 0.15F));
        put("minecraft:small_fireball", new TrailConfigData(0.2F, 5, 0.001F, 1, "#FFEBAA18", "#80800000", new Vector3f(0F, 0.15F, 0F), 0F, 0.15F));
        put("minecraft:dragon_fireball", new TrailConfigData(0.45F, 5, 0.001F, 1, "#FFD974F7", "#80FF00D0", new Vector3f(0F, 0.35F, 0F), 0F, 0.15F));
        put("minecraft:wither_skull", new TrailConfigData(0.1F, 5, 0.001F, 1, "#FF576868", "#80000000", new Vector3f(0F, 0.125F, 0F), 0F, 0.15F));
        put("minecraft:wind_charge", new TrailConfigData(0.075F, 10, 0.001F, 1, "#FFE8ECFC", "#80000000", new Vector3f(0F, 0.05F, 0F), 0F, 0.15F));
        put("minecraft:breeze_wind_charge", new TrailConfigData(0.075F, 10, 0.001F, 1, "#FFE8ECFC", "#80000000", new Vector3f(0F, 0.05F, 0F), 0F, 0.15F));
        put("minecraft:eye_of_ender", new TrailConfigData(0.075F, 10, 0.001F, 1, "#FF6321A6", "#80FF00D0", new Vector3f(0F, 0.125F, 0F), 0F, 0.15F));
        put("minecraft:vex", new TrailConfigData(0.15F, 20, 0.001F, 1, "#FF515F6D", "#80000000", new Vector3f(0F, 0.4F, 0F), 0F, 0.15F));
        put("minecraft:allay", new TrailConfigData(0.15F, 20, 0.001F, 1, "#FF63F8FC", "#80000000", new Vector3f(0F, 0.3F, 0F), 0F, 0.15F));
    }};
